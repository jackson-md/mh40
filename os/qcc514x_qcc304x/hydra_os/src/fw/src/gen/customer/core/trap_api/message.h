...
/**
 *  \brief Register Link Status Tracking events task.
 *           Register a task to receive periodic MESSAGE_LINK_STATUS messages. 
 *           
 *  \param task The task which will receive the messages.
 *  \return The old task (or zero).
 * 
...
/**
 *  \brief Register a task to handle messages from a sensor.
 *  \param sensor_id The Sensor ID.
 *  \param task This task will receive \#MESSAGE_SENSOR_DATA messages.
 *  \return The old task (or zero).
 * 
