...
/**
 *  \brief Return ISP debug Source Stream
 *         Source stream used to return information from the on-chip debug.
 *         
 *  \return Stream Source for reading data.
 * 
 * \ingroup trapset_stream
 */
Source StreamIspSource(stream_isp_role role);

/**
 *  \brief Return ISP debug Sink Stream
 *         Sink stream used to send information to the on-chip debug (or forward
 *  on).
 *         
 *  \return Stream Sink for writing data.
 * 
 * \ingroup trapset_stream
 */
Sink StreamIspSink(stream_isp_role role);
