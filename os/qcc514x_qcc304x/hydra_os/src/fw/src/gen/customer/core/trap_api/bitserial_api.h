 ...
 *         operations.
 *         
 *         Bitserial transfers (including BitserialRead and BitserialWrite) will
 *         run on P1 if one of the following bitserial_block_index is used:
 *         P1_BITSERIAL_BLOCK_0,
 *         P1_BITSERIAL_BLOCK_1,
 *         P1_BITSERIAL_BLOCK_2.
 *         
 *         Otherwise they will run on P0 if one of the following
 *         bitserial_block_index is used:
 *         BITSERIAL_BLOCK_0,
 *         BITSERIAL_BLOCK_1,
 *         BITSERIAL_BLOCK_2.
 *         
 *         Running transfers on P1 allows to achieve more predictable timing
 ...
 *         
 *         Application must not mix blocking and non-blocking transfers, in general
 *         blocking transfers can be used only when all non-blocking transfers have
 *         completed.
 *         
