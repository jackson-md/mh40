...
#ifndef PMALLOC_MAX_DEBUG_BLOCKS
#define PMALLOC_MAX_DEBUG_BLOCKS (460)   /* Generic value for P1. Can be overridden by app */
#endif
...
extern uint32 pmalloc_current_bytes_out;
extern uint32 pmalloc_highest_bytes_out;
#ifdef PMALLOC_RECORD_SNAPSHOT
extern uint8 *pmalloc_snapshot;
#endif
#endif
