...
#include "nfc/nfc/nfc_panicids.h"
    ...
    */
    ...
    /**
     * Failed to take or give sensor hub semaphore.
     */
    PANIC_SENSOR_HUB_SEMAPHORE_FAILED = 0x104,

    /**
     * Failed to configure PIOs for sensor hub.
     */
    PANIC_SENSOR_HUB_PIO_CONFIGURE_FAILED = 0x105,

    /**
     * The ISP stream has received a bad RFISP packet over the host link.
     */
    PANIC_STREAM_ISP_BAD_PACKET = 0x106,

    /**
     * OBPM interface failed in an unexpected way.
     */
    PANIC_OBPM_FAILED = 0x107,

    /**
     * The Audio Patch Bundle version isn't sufficient for the Product Code.
     */
    PANIC_AUDIO_MINIMUM_PATCH_VERSION = 0x108,

    /**
     * CLK CTRL module encountered an error.
     */
    PANIC_CLK_CTRL = 0x109,
