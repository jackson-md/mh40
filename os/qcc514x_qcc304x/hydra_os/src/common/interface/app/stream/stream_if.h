...
typedef enum
{
    ...
    STREAM_PCM_SLOT_COUNT = 0x0103,                         /*!< PCM slot count. Valid range 0 to 4 inclusive for devices up to QCC5171 and 0 to 8 inclusive for 
                                                                 QCC5171 and newer devices. If 0, slot count will be derived from master clock
    ...
    STREAM_MON_OUT_SELECT_ANC_SIGNAL = 0x0651,                 /*!< Configure the monitor output from different tap points of ANC HW.*/
    STREAM_MON_OUT_SELECT_CODEC_LOOPBACK = 0x0652,             /*!< Configure the monitor output from different tap points of DAC HW to ADC.*/
    STREAM_MON_OUT_SELECT_CODEC_DMIC_ROUTING = 0x0653,         /*!< Configure the monitor output by routing a codec or DMIC input.*/
    ...
    STREAM_ISP_ROLE = 0x0B00,                              /*!< Configure the role of an ISP stream */
    
    /* 0x0C00 - 0x0F00 available */
...
/*!
    @brief Monitor_OUT signal tapped from ANC HW block
*/
typedef enum
{
    FFA_IN_ANC0             = 0x0000,
    ...
    FB_IN_ANC1              = 0x0101,
    ANC_OUT_ANC1            = 0x0102,
    FB_MON_SIGNAL_OFF_ANC0  = 0x00FF,
    FB_MON_SIGNAL_OFF_ANC1  = 0x01FF
}mon_out_anc_signals;

/*!
    @brief Monitor_OUT signal tapped through different tap points of DAC
*/
typedef enum
{
    CODEC_LOOPBACK_OFF            = 0x0000,
    CODEC_SHORT_DIG_LOOPBACK_DAC0 = 0x0001,
    CODEC_LONG_DIG_LOOPBACK_DAC0  = 0x0002,
    CODEC_SHORT_ANA_LOOPBACK_DAC0 = 0x0003,
    CODEC_LONG_ANA_LOOPBACK_DAC0  = 0x0004,
    CODEC_SHORT_DIG_LOOPBACK_DAC1 = 0x0101,
    CODEC_LONG_DIG_LOOPBACK_DAC1  = 0x0102,
    CODEC_SHORT_ANA_LOOPBACK_DAC1 = 0x0103,
    CODEC_LONG_ANA_LOOPBACK_DAC1  = 0x0104
}mon_out_codec_loopback_signals;

/*!
    @brief Monitor_OUT signal tapped at different adc or dmic interface
*/
typedef enum
{
    CODEC_DMIC_INSTANC_0_CHAN_A   = 0x0000,
    CODEC_DMIC_INSTANC_0_CHAN_B   = 0x0001,
    CODEC_DMIC_INSTANC_1_CHAN_A   = 0x0002,
    CODEC_DMIC_INSTANC_1_CHAN_B   = 0x0003,
    CODEC_DMIC_INSTANC_2_CHAN_A   = 0x0004,
    CODEC_DMIC_INSTANC_2_CHAN_B   = 0x0005,
    CODEC_DMIC_INSTANC_3_CHAN_A   = 0x0006,
    CODEC_DMIC_INSTANC_3_CHAN_B   = 0x0007,
    CODEC_DMIC_INSTANC_4_CHAN_A   = 0x0008,
    CODEC_DMIC_INSTANC_4_CHAN_B   = 0x0009,
    CODEC_DMIC_SIGNAL_ROUTING_OFF = 0x00FF
}mon_out_codec_dmic_signals;

/*!
    @brief Values used with #STREAM_ISP_ROLE.
*/
typedef enum
{
    ISP_ROLE_SINGLE     = 0x00,
    ISP_ROLE_LEFT       = 0x01,
    ISP_ROLE_RIGHT      = 0x02,
    ISP_ROLE_PRIMARY    = 0x10,
    ISP_ROLE_SECONDARY  = 0x20,
    ISP_ROLE_FORWARDING = 0xFF
} stream_isp_role;
