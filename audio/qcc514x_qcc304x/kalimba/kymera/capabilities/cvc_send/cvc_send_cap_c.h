...
/* Capability   Version */
#define CVC_SEND_CAP_VERSION_MINOR                          17
...
#define HIGHNOISE_FLAG_POS                   1
#define MIC_MALFUNC_FLAG_POS                 2
#define LOOSE_FIT_FLAG_POS                   3
#define THREE_MIC_FLAG_POS                   4
#define REF_PWR_FLAG_POS                     5
