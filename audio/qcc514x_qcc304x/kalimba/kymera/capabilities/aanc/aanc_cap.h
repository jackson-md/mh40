 ...
 */
#define AANC_INVALID_FINE_GAIN   0xFFFF
#define AANC_INVALID_COARSE_GAIN 0x1000
...
#define AANC_RE_FREEZE_FFGAIN_THRESHOLD    4
...
typedef enum
{
    ...
    AANC_FFGAIN_BEFORE_EXIT_FREEZE,
    AANC_FFGAIN_RAMP_FF_GAIN,
