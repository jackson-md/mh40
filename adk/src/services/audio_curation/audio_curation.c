...
static void handleAncUiDomainInput(MessageId ui_input)
{
    ...
    switch(ui_input)
    {
        ...
        case ui_input_anc_set_world_vol_up:
            DEBUG_LOG("handleAncUiDomainInput, anc set world volume up");
            AncStateManager_SetWorldVolumeUp();
            break;

        case ui_input_anc_set_world_vol_down:
            DEBUG_LOG("handleAncUiDomainInput, anc set world volume down");
            AncStateManager_SetWorldVolumeDown();
            break;
        ...
        case ui_input_anc_wind_detected:
            DEBUG_LOG_ALWAYS("handleAncUiDomainInput, wind detected");
            /*Wind detection logic goes here*/
            AncStateManager_HandleWindDetect();
            break;

        case ui_input_anc_wind_released:
             DEBUG_LOG_ALWAYS("handleAncUiDomainInput, wind released");
             /* Wind relese logic goes here*/
             AncStateManager_HandleWindRelease();
             break;
             
         case ui_input_anc_wind_enable:
             DEBUG_LOG_ALWAYS("handleAncUiDomainInput, wind enable");
             AncStateManager_HandleWindEnable();
             break;
             
         case ui_input_anc_wind_disable:
             DEBUG_LOG_ALWAYS("handleAncUiDomainInput, wind disable");
             AncStateManager_HandleWindDisable();
             break;

        case ui_input_anc_auto_transparency_enable:
            DEBUG_LOG_ALWAYS("handleAncUiDomainInput, auto_transparency enable");
            AncAutoAmbient_Enable(TRUE);
            break;
            
        case ui_input_anc_auto_transparency_disable:
            DEBUG_LOG_ALWAYS("handleAncUiDomainInput, auto_transparency disable");
            AncAutoAmbient_Enable(FALSE);
            break;
            
        case ui_input_anc_auto_transparency_release_time:
            DEBUG_LOG_ALWAYS("handleAncUiDomainInput, auto_transparency release time");
            AncAutoAmbient_UpdateReleaseTime();
            break;

         case ui_input_anc_anti_howling_enable:
             DEBUG_LOG_ALWAYS("handleAncUiDomainInput, anti howling enable");
             AncStateManager_HandleAntiHowlingEnable();
             break;

         case ui_input_anc_anti_howling_disable:
             DEBUG_LOG_ALWAYS("handleAncUiDomainInput, anti howling disable");
             AncStateManager_HandleAntiHowlingDisable();
             break;       
        ...
        case ui_input_anc_set_world_volume_gain:
            DEBUG_LOG("handleAncUiDomainInput, set world volume gain input");
            AncStateManager_UpdateWorldVolumeGain();
            break;

        case ui_input_anc_set_world_volume_balance:
            DEBUG_LOG("handleAncUiDomainInput, set world volume balance input");
            AncStateManager_UpdateWorldVolumeBalance();
            break;
