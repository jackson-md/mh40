...
/*! \brief Deselects the current assistant
 */
...
/*! \brief Get the feature manager handle for VA
    \return The feature manager handle for VA
 */
feature_manager_handle_t VoiceUi_GetFeatureManagerHandle(void);

/*! \brief Set the feature manager handle for VA
    \param handle The feature manager handle for VA
 */
