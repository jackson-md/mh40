...
/*! \brief  This allocates and initializes the instance structure of the RAFS.
 */
void Rafs_CreateInstanceStructure(void);

/*!
 * \brief Rafs_CreateFilesStructure
 * This function allocates and initializes the files pointer of the rafs instance.
 */
void Rafs_CreateFilesStructure(void);

/*!
 * \brief Rafs_FreeFilesStructure
 * This function frees and initializes the files pointer of the rafs instance if it is not anymore in use.
 */
void Rafs_FreeFilesStructure(void);

/*!
 * \brief Rafs_FreePartitionStructure
 * This function frees the instance partition structure.
 */
void Rafs_FreePartitionStructure(void);
