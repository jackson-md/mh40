...
typedef enum
{
    ...
    PEER_FIND_ROLE_INIT_CFM,
    	/*! Peer Find Role has been started */
    PEER_FIND_ROLE_STARTED,
...
/*! \brief Register a client task to receive PEER_FIND_ROLE_STARTED indication

    \param task Client task to register.
*/
void PeerFindRole_RegisterStartClient(Task task);

/*! \brief Un-register a client task to receive PEER_FIND_ROLE_STARTED indication
