...
/*! Dsiplay error message if application using INCLUDE_HDMA_CIS_RSSI_EVENT
    without CIS delegation support
*/
...
/*! Structure describing CIS RSSI quality of the earbud */
typedef struct {
    /*! absolute RSSI of bud (dBm)*/
    int8 rssi;
}hdma_core_cis_rssi_t;
...
typedef enum {
    ...
    /*! HDMA CORE handover reason CIS signal quality. */
    HDMA_CORE_HANDOVER_REASON_CIS_RSSI
...
typedef struct {
    ...
    hdma_core_result_queue_t phoneCisRSSI;
