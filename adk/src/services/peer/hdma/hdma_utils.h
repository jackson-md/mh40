...
#define HDMA_DEBUG_LOG_DEBUG(...) printf(__VA_ARGS__)
#define HDMA_DEBUG_LOG_VERBOSE(...) printf(__VA_ARGS__)
#else
	/*! Print Debug logs */
...
/*! Print Debug logs for level debug */
#define HDMA_DEBUG_LOG_DEBUG(...) DEBUG_LOG_DEBUG(__VA_ARGS__)
/*! Print Debug logs for level verbose */
#define HDMA_DEBUG_LOG_VERBOSE(...) DEBUG_LOG_VERBOSE(__VA_ARGS__)
#endif
...
extern const hdma_thresholds_t cis_rssi;
#endif
