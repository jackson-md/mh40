...
typedef enum {
    ...
    /*! HDMA handover reason BREDR signal quality. */
    ...
    /*! HDMA recommends handover with this reason when its own
        CIS RSSI falls below the absolute threshold critical value.
        Handover for single CIS is not supported.
    */
    HDMA_HANDOVER_REASON_CIS_RSSI
