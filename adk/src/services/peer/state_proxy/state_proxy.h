...
typedef enum
{
    ...
    state_proxy_event_type_cis_rssi             = 1UL << 11,
    state_proxy_event_type_aanc_fb_gain_logging = 1UL << 12,
...
typedef enum
{
    ...
    state_proxy_anc_msg_id_world_volume_gain,
    state_proxy_anc_msg_id_world_volume_balance,
    state_proxy_anc_msg_id_prev_config,
    state_proxy_anc_msg_id_prev_mode,
     state_proxy_aanc_msg_id_fb_gain,
...
typedef struct
{
    ...
    union
    {
        ...
        ANC_WORLD_VOLUME_GAIN_DB_UPDATE_IND_T world_volume_gain;
        ANC_WORLD_VOLUME_BALANCE_UPDATE_IND_T balance_info;
        ANC_UPDATE_PREV_CONFIG_IND_T prev_config;
        ANC_UPDATE_PREV_MODE_IND_T prev_mode;
        AANC_FB_GAIN_UPDATE_IND_T fb_gain;
...
/*! Definition of data for state_proxy_event_type_aanc_fb_gain_logging events. */
typedef AANC_FB_GAIN_LOGGING_T STATE_PROXY_AANC_FB_GAIN_LOGGING_T;
...
typedef struct
{
    ...
    union
    {
        ...
        STATE_PROXY_CIS_RSSI_T cis_rssi;
    } event;
} STATE_PROXY_EVENT_T;
