...
/*! \brief Transfer call audio from the headset to the handset

    \param source The voice source to transfer audio from/to
 */
void TelephonyService_TransferAudioToHandset(voice_source_t source);

/*! \brief Transfer call audio from handset to headset

    \param source The voice source to transfer audio from/to
 */
void TelephonyService_TransferAudioToHeadset(voice_source_t source);

/*! \brief Transfer call audio to/from the handset
