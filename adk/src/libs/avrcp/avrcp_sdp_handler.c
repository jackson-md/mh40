...
static const uint8 addProtocolDescriptorList[] =
{
    0x09, 0x00, 0x0d,           /* Additional Profile Descriptor List */
        0x35, 0x12              /* Data Element Sequence of 18 */  
};

static const uint8 protocolDescriptor[] =
{
                                           ...
                                           uint16 *record_len)
{
    ...
    {
         size_record += sizeof(addProtocolDescriptorList);
         size_record += sizeof(protocolDescriptor);
    }
    ...
    memmove(&service_record[size_record], protocolDescriptor,
            sizeof(protocolDescriptor));
    size_record += sizeof(protocolDescriptor);
    ...
    if(avrcp_browsing_supported(avrcp))
    {
        memmove(&service_record[size_record], addProtocolDescriptorList, 
                sizeof(addProtocolDescriptorList));
        size_record += sizeof(addProtocolDescriptorList);
