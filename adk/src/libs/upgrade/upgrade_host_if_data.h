 ...
 */
#define PROTOCOL_CURRENT_VERSION    PROTOCOL_VERSION_5
...
/*!
    ...
    @param is_data_cfm_needed this function sets it TRUE if the calling function need to send the data confirmation to transport. FALSE if client will do it.
