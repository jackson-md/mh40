...
void UpgradeSMHandleRebootAction(void)
{
        ...
        {
            DEBUG_LOG_INFO("UpgradeSMHandleValidated: Interactive Commit");
        ...
        {
            DEBUG_LOG_INFO("UpgradeSMHandleValidated: Silent Commit");
    ...
    case UPGRADE_HOST_TRANSFER_COMPLETE_RES:
        {
            ...
            if(msg !=NULL)
            {
                ...
                UpgradeSendUpgradeOpsStatus(UpgradeGetAppTask(), upgrade_ops_check_peer_connection_pre_reboot, NO_ACTION);
            }
            /* Abort */
            else
            {
