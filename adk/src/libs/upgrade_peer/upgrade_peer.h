...
typedef enum
{
    ...
    UPGRADE_PEER_BLOCK_UNTIL_DFU_PEER_CONNECTED
...
/*!
    ...
    @note: Reset the abort state variable of peer maintained by library
           as this can be inappropriate if a handover has kicked in.
...
/*!
    @brief Reconnect Peer for reboot
    returns None
*/
