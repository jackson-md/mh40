...
typedef enum
{
    capability_load_to_p0_use_on_p0_only = 0,
    capability_load_to_p0_use_on_both = 1,
    capability_load_to_p1_use_on_p1_only = 2,
    capability_load_to_p1_use_on_both = 3,
...
/*!
    \brief  Vmal wrapper around operatorBundleLoad which creates a "bundle" file containing one 
            or more audio processing capabilities into the audio subsystem.
 
    \param index Specifies a .dkcs file containing capability code.
    \param capability Indicates which audio processor the code is intended to run on
