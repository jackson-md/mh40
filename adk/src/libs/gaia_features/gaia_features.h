...
typedef enum
{
    ...
    GAIA_UI_USER_CONFIG_FEATURE_ID = 0x0b,      /*<! Gaia end-user UI configuration plugin feature ID */
    GAIA_STATISTICS_FEATURE_ID = 0x0c,          /*<! Gaia statistics plugin feature ID */
    GAIA_BATTERY_FEATURE_ID = 0x0d,             /*<! Gaia battery plugin feature ID */
} gaia_features_t;
