...
/*! \brief Get the unique index of the device on the list.
    \return The device index, or 0xFF if the device was not found on the list.
*/
uint8 DeviceList_GetIndexOfDevice(device_t device);

/*! \brief Get the device at the specified index.
    \return The device, which may be NULL.
*/
