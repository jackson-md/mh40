...
#define ANC_INSTANCE_1_INDEX_OFFSET        3
...
#define FINE_GAIN_TUNE_DATA_ENTRIES_HS     6
#define FINE_GAIN_TUNE_DATA_SIZE_HS       (FINE_GAIN_TUNE_DATA_ENTRIES_HS)
...
#ifdef ANC_UPGRADE_FILTER
#define GAIN_SHIFT_LOWER_LIMIT           (int16)(-8)   /* -48.0dB, Lower limit of coarse value for Mora2.0 platforms */
#define GAIN_SHIFT_UPPER_LIMIT           (6U)          /* 36.0dB, Upper limit of coarse value for Mora2.0 platforms */
#else
#define GAIN_SHIFT_LOWER_LIMIT           (int16)(-4)   /* -24.0dB, Lower limit of coarse value for Auraplus platforms */
#define GAIN_SHIFT_UPPER_LIMIT           (6U)          /* 36.0dB, Upper limit of coarse value for Auraplus platforms */
#endif
enum
{
