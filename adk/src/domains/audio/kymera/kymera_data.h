...
typedef struct
{
    ...
    */
    ...
    unsigned aptx_adaptive_r22_dec:1;
    unsigned aptx_adaptive_r22_enc:1;
    ...
    bool ultra_quiet_dac_enable_status;
    bool ultra_quiet_dac_enable_request;
#endif
    ...
    vm_transform_ttp_ssrc_pair *aptx_adaptive_ttp_ssrc;
} kymeraTaskData;
