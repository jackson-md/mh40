...
/*! \brief Set table used to determine audio chain based on LE Audio parameters.
    ...
    Based on chain_table index, appropriate chain configuration is selected.
    If index is 0, mono decoder chain configuration is used.
    If index is 1, split stereo decoder chain configuration is used.
...
*/
void Kymera_LeVoiceStart(int16 volume_in_db, const le_voice_config_t *le_voice_config);
