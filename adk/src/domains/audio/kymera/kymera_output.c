...
static void kymeraConfigureVolumeControlAuxBuffer(kymera_chain_handle_t chain, const kymera_output_chain_config *config)
{
    ...
    switch(config->kick_period)
    {
        ...
        /*
            ...
            The buffer size in KICK_PERIOD_FAST case is increased to 500 words for LEA support build as 480 words is not large enough 
            to hold enough samples for the kick to occur on time.
         */
