...
enum app_kymera_internal_message_ids
{
    ...
    /*! Internal message to retry connecting self speech after ANC transition is complete*/
    KYMERA_INTERNAL_SELF_SPEECH_ENABLE_TIMEOUT,
    /*! Internal message to retry disconnecting self speech after ANC transition is complete*/
    KYMERA_INTERNAL_SELF_SPEECH_DISABLE_TIMEOUT,
