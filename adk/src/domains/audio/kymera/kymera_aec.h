...
/*! \brief Returns TRUE if an output connection to aec reference exists. */
...
/*! \brief Sets the ttp delay for aec_ref. */
void Kymera_AecSetTtpDelay(uint32 ttp_delay);

/*! \brief Activates / deactivates the timestamp generation for aec_ref. */
