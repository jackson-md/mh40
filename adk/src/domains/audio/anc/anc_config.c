...
const anc_config_data_t anc_config_data[ANC_CONFIG_MAX_MODE] = 
{
    ...
    {ANC_CONFIG_MODE_ADAPTIVE, ANC_CONFIG_MODE_LEAKTHROUGH},        /*anc_mode_4*/ /* Adaptive Transparency EANC */
#else /* HAVE_RDP_HW_YE134 */
    {ANC_CONFIG_MODE_STATIC, ANC_CONFIG_MODE_NOISE_CANCELLATION},   /*anc_mode_4*/ /* Static ANC (Wide tuning) EANC */
#endif
    {ANC_CONFIG_MODE_STATIC, ANC_CONFIG_MODE_LEAKTHROUGH},          /*anc_mode_5*/ /* Static Transparency EANC */
