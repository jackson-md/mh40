...
/*! \brief ANC State Manager Events which are triggered during state transitions */
typedef enum
{
    anc_state_manager_event_initialise = INTERNAL_MESSAGE_BASE,
    ...
    anc_state_manager_event_read_aanc_gain_timer_expiry,
    ...
    anc_state_manager_event_capability_disable_complete,
    anc_state_manager_event_capability_enable_complete,
    anc_state_manager_event_capability_mode_change_trigger,
    anc_state_manager_internal_event_mode_change,
    anc_state_manager_internal_event_enable,
    anc_state_manager_internal_event_disable,
    anc_state_manager_event_toggle_way,
    anc_state_manager_event_concurrency_connect_req,
    anc_state_manager_event_concurrency_disconnect_req,
    /*Events handles with lock condition */
    ...
    anc_state_manager_event_world_volume_up,
    anc_state_manager_event_world_volume_down,
    ...
    anc_state_manager_event_wind_detect,
    anc_state_manager_event_wind_release,
    anc_state_manager_event_wind_enable,
    anc_state_manager_event_wind_disable,
    anc_state_manager_event_set_anc_leakthrough_gain,
    anc_state_manager_event_set_world_volume_gain,
    anc_state_manager_event_set_world_volume_balance,
    anc_state_manager_event_anti_howling_enable,
    anc_state_manager_event_anti_howling_disable
