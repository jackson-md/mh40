...
typedef enum
{
    ...
    context_audio_is_paused,                /*!< Receiving an audio stream with paused context */
    context_audio_is_high_priority,         /*!< Receiving high priority audio */
    context_audio_is_broadcast,             /*!< Receiving a broadcast stream */
    max_audio_contexts
...
/*! \brief Get the Audio Source Interface Device associated with the provided Audio Source.

    \param source The source for which to get the Source Device.

    \return The device associated with the source
 */
device_t AudioSources_GetAudioSourceDevice(audio_source_t source);
...
/*! \brief Get the Media Control Interface Source Device associated with the provided Audio Source.

    \param source The source for which to get the Source Device.

    \return The device associated with the source
 */
device_t AudioSources_GetMediaControlSourceDevice(audio_source_t source);

/*! \brief Registers a media control context override interface.

    \param interface The context override interface to register

 */
bool AudioSources_RegisterMediaControlContextOverrideInterface(const media_context_override_interface_t * interface);
