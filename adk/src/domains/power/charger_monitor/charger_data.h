...
enum charger_monitor_internal_messages
{
    ...
    /*! Disable the charger after the HW has completed. */
    CHARGER_INTERNAL_DISABLE_AFTER_CHARGED,
...
extern chargerTaskData app_charger_data;
#define appGetCharger()     (&app_charger_data)
