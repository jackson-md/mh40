...
/*! \brief This will send a message (POWER_ON) to all registered clients to indicate
           that the device is powered on.
    \note In case of earbud, if it is peer paired and not in the case, appPowerOn() 
          shall only be called after peer find role has started. 
*/
