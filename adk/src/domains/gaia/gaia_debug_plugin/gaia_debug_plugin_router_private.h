...
#define GAIA_DEBUG_TUNNEL_HEADER_SIZE       (8 + 1 + GAIA_DEBUG_TUNNEL_TO_CHIP_CMD_RSP_PARAMETER_HEADER_SIZE)

/*! \brief Maximum header size for PyDbg Remote Debug Routed-Type PDU. */
#define PYDBG_REMOTE_DEBUG_MAX_HEADER_SIZE  (GAIA_DEBUG_TUNNEL_HEADER_SIZE + PYDBG_REMOTE_DEBUG_PDU_ROUTED_TYPE_HEADER_SIZE + 4)

/*! \brief The minimum payload size for PyDbg Remote Debug Routed-Type commands. */
#define PYDBG_REMOTE_DEBUG_MIN_PAYLOAD_SIZE     (20)

#ifdef GAIA_DEBUG_OVERRIDE_TRANSPORT_PDU_SIZE
  #if (254 < GAIA_DEBUG_OVERRIDE_TRANSPORT_PDU_SIZE)
    #error GAIA_DEBUG_OVERRIDE_TRANSPORT_PDU_SIZE must be 254 or less.
  #elif (GAIA_DEBUG_OVERRIDE_TRANSPORT_PDU_SIZE < (PYDBG_REMOTE_DEBUG_MAX_HEADER_SIZE + PYDBG_REMOTE_DEBUG_MIN_PAYLOAD_SIZE))
    #error GAIA_DEBUG_OVERRIDE_TRANSPORT_PDU_SIZE is too small.
  #endif
#define PYDBG_REMOTE_DEBUG_MAX_PDU_SIZE                             (GAIA_DEBUG_OVERRIDE_TRANSPORT_PDU_SIZE - GAIA_DEBUG_TUNNEL_HEADER_SIZE)
#else
#define PYDBG_REMOTE_DEBUG_MAX_PDU_SIZE                             (254 - GAIA_DEBUG_TUNNEL_HEADER_SIZE)
#endif
