...
\file       timestamp_event.h
\defgroup   timestamp_event Timestamp Event
...
typedef enum
{
    ...
    /*! First BT event after apps initilization */
    TIMESTAMP_EVENT_BT_ADDRESS_READ,
    ...
    /*! HIDD profile connected to handset */
    TIMESTAMP_EVENT_PROFILE_CONNECTED_HIDD,

    /*! BTDBG profile connected to handset */
    TIMESTAMP_EVENT_PROFILE_CONNECTED_BTDBG,
    ...
    /*! HIDD profile disconnected from handset */
    TIMESTAMP_EVENT_PROFILE_DISCONNECTED_HIDD,

    /*! BTDBG profile disconnected from handset */
    TIMESTAMP_EVENT_PROFILE_DISCONNECTED_BTDBG,
    ...
    /*! Event to record the time when Kymera creates & starts the stereo audio 
        chain */
