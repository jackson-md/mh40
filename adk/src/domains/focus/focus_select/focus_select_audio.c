...
static int8 audio_context_to_audio_prio_mapping[] = {
    ...
    [context_audio_is_broadcast] = 3,
    [context_audio_is_streaming] = 4,
    [context_audio_is_playing] = 5,
    [context_audio_is_high_priority] = 6,
    [context_audio_is_va_response] = 7,
};
...
static int8 voice_context_to_audio_prio_mapping[] = {
    ...
    [context_voice_ringing_incoming] = 7,
    [context_voice_call_held] = 7,
    [context_voice_ringing_outgoing] = 8,
    [context_voice_in_call] = 8,
    [context_voice_in_call_with_incoming] = 8,
    [context_voice_in_call_with_outgoing] = 8,
    [context_voice_in_call_with_held] = 8,
    [context_voice_in_multiparty_call] = 8,
};
...
bool FocusSelect_DeviceHasVoiceOrAudioForegroundFocus(device_t device)
{
    ...
    else if (FocusSelect_GetFocusForAudioSource(audio_source) == focus_foreground)
    {
        device_has_voice_or_audio_focus = TRUE;
    }
