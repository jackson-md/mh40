...
static bool a2dp_barge_in_enabled_for_sass;
...
void FocusSelect_TieBreakInit(void)
{
    ...
    a2dp_barge_in_enabled_for_sass = FALSE;
}
    ...
    case FOCUS_SELECT_AUDIO_A2DP:
        {
            ...
            if(a2dp_barge_in_enabled || a2dp_barge_in_enabled_for_sass || source == audio_source_none)
            {
...
void FocusSelect_HandleTieBreak(focus_status_t * focus_status)
{
    ...
    {
        DEBUG_LOG_VERBOSE("FocusSelect_HandleTieBreak last routed audio enum:audio_source_t:%d", last_routed_audio);
...
{
    a2dp_barge_in_enabled_for_sass = barge_in_enable;
}

bool FocusSelect_IsA2dpBargeInEnabled(void)
{
    return a2dp_barge_in_enabled;
}