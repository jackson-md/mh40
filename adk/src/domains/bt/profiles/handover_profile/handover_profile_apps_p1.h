...
/*! \brief Checks if any of the appsP1 clients vetoes handover for global, or
    per link reasons.
    \return Status of operation.
*/
handover_profile_status_t handoverProfile_VetoP1Clients(void);

/*! \brief Checks if any of the appsP1 clients vetoes handover for global, non
    per link reasons.
    \return Status of operation.
*/
handover_profile_status_t handoverProfile_VetoP1ClientsGlobal(void);

/*! \brief Checks if any of the appsP1 clients vetoes handover for each link
    being handed over.
    \return Status of operation.
*/
