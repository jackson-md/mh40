...
static const uint16 l2cap_conftab[] =
{
    ...
    L2CAP_AUTOPT_MTU_IN,            HANDOVER_PROFILE_L2CAP_MTU_SIZE, /* Maximum inbound MTU */
    L2CAP_AUTOPT_MTU_OUT,           HANDOVER_PROFILE_L2CAP_MTU_SIZE, /* Minimum acceptable outbound MTU */
...
static void handoverProfile_EnterConnected(void)
{
    ...
    if (ho_inst->is_primary)
    {
        ...
        ho_inst->peer_firmware = HANDOVER_PROFILE_PEER_FIRMWARE_UNKNOWN;
    }
    else
    {
