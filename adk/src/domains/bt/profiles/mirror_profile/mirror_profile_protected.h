...
/*! \brief Set the role of mirror profile and also swap to corresponding peer address if not done already

    \param is_primary TRUE if role is primary, FALSE otherwise.
*/
