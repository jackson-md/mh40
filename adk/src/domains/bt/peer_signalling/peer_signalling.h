...
typedef enum
{
    ...
    /*! Channel ID for Accessory messages. */
    PEER_SIG_MSG_CHANNEL_ACCESSORY,
#endif

#ifdef INCLUDE_AMA
    /*! Channel ID for AMA messages. */
    PEER_SIG_MSG_CHANNEL_AMA,
#endif
    ...
    /*! Channel ID for sensor profile messages. */
