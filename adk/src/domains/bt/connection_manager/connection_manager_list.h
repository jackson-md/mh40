...
/*! \brief Find LE-ACL connection from resolved typed bluetooth address
    \param taddr Resolved typed bluetooth address of LE-ACL link

    \return The LE-ACL connection record matching with resolved typed address
 */
