...
/*! \brief Check if extended advertising is inactive

    This covers the states of idle and suspended

    \return TRUE if extended advertising is inactive, FALSE otherwise
 */
...
#define LeAdvertisingManager_IsExtendedAdvertisingInactive() (TRUE)
