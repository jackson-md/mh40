...
typedef void(*SetupAdvertData)(Task task, uint8 adv_handle);
typedef void(*SetupScanResponseData)(Task task, uint8 adv_handle);
typedef bool(*GetDataPacket)(le_adv_manager_data_packet_type_t type, le_advertising_manager_data_packet_t *packet);
