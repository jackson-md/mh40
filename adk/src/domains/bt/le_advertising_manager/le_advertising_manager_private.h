...
/* Use the new advertising set state machine for extended advertising. */
/*#define USE_NEW_SM_FOR_EXTENDED_ADVERTISING*/

/* Use the new advertising set state machine for legacy advertising. */
/*#define USE_NEW_SM_FOR_LEGACY_ADVERTISING*/

#define LEGACY_ADV_HANDLE_APP_SET                 2
#define LEGACY_ADV_FILTER_POLICY                  0
#define LEGACY_ADV_PRIMARY_PHY                    1
#define LEGACY_ADV_SECONDARY_PHY                  1
#define LEGACY_ADV_SECONDARY_MAX_SKIP             0
#define LEGACY_ADV_SID                            0x100
...
typedef enum 
{
    ...
    LE_ADV_MGR_INTERNAL_RESTART_ADVERTISING,
    LE_ADV_MGR_INTERNAL_RESTART_CHECK_STOPPED,
    LE_ADV_MGR_INTERNAL_UNBLOCKED,

        /*! This must be the final message */
    LE_ADV_MGR_INTERNAL_MESSAGE_END
} adv_mgr_internal_messages_t;
...
/*! \brief Flags used in is_advertising_blocked variable
            to determine reason for block
    \note */
typedef enum
{
    le_adv_block_advertising_topology = (1 << 0),
    le_adv_block_advertising_restart = (1 << 1),
} le_adv_advertising_blocks_t;
...
typedef struct
{
    ...
    /*! Flag to indicate whether all advertising event types are blocked */
    uint16                      is_advertising_blocked;
...
#define leAdvertisingManager_IsAdvertisingAllowed() (app_adv_manager.is_advertising_blocked == 0)
...
/*! Handle a CL_DM_BLE_SET_ADVERTISE_ENABLE_CFM for the legacy advertising. */
