...
\defgroup   bandwidth_manager Bandwidth Manager
\ingroup    bt_domain
...
typedef enum
{
    ...
    BANDWIDTH_MGR_FEATURE_LE_BROADCAST,
    BANDWIDTH_MGR_FEATURE_LE_UNICAST,
    BANDWIDTH_MGR_FEATURE_LAST = BANDWIDTH_MGR_FEATURE_LE_UNICAST,
