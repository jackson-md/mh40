...
/*! Isochronous QHS octet */
#define QHS_MODE_ISO_OCTET  2
/*! QHS mode Iso mask */
#define QHS_MODE_ISO_MASK   0x40

/*! LE Audio class bit position */
#define LE_AUDIO_MAJOR_SERV_CLASS_BIT_POS   14
...
typedef enum
{
    ...
    /*! Message to trigger reading remote features */
    QCOM_CON_MANAGER_INTERNAL_READ_QLL_REMOTE_FEATURES,
...
/*! Message content for QCOM_CON_MANAGER_INTERNAL_READ_QLL_REMOTE_FEATURES */
typedef struct
{
    /*! Address of remote device */
    TP_BD_ADDR_T tp_addr;
} QCOM_CON_MANAGER_INTERNAL_READ_QLL_REMOTE_FEATURES_T;
