...
/* Offset of the PSM in the Sensor Profile service record */
#define SENSOR_PROFILE_L2CAP_PSM_OFFSET (33)

/* Sensor Profile service record */
static const uint8 sensor_profile_service_record[] =
{
   /* Offset */ /* ServiceClassIDList(0x0001), Data Element Sequence */
    /*  0 */    SDP_ATTR_ID(UUID_SERVICE_CLASS_ID_LIST),
    /*  3 */        SDP_DATA_EL_SEQ(17),

    /*  UUID Qualcomm Sensor Profile (0000eb08-d102-11e1-9b23-00025b00a5a5) */
    /*  5 */        SDP_DATA_EL_UUID128(UUID_SENSOR_PROFILE_SERVICE),
...
{
    return sensor_profile_service_record;
}

uint16 appSdpGetSensorProfileServiceRecordSize(void)
{
    return sizeof(sensor_profile_service_record);
}

uint16 appSdpGetSensorProfileServiceRecordPsmOffset(void)
{
    return SENSOR_PROFILE_L2CAP_PSM_OFFSET;
}

/* Sensor Profile service search request */
static const uint8 sensor_profile_attribute_list[] =
{
    SDP_DATA_EL_SEQ(3),                                /* Data Element Sequence of 3 */
        SDP_ATTR_ID(UUID_PROTOCOL_DESCRIPTOR_LIST),
};
...
{
    *size = sizeof(sensor_profile_attribute_list);
    return sensor_profile_attribute_list;
}
