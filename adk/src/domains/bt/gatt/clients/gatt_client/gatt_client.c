...
static inline void gattClient_SetClientConnectionID(gatt_client_t *client, gatt_cid_t cid)
{
...
bool GattClient_DetachClient(client_id_t client_id, gatt_cid_t cid)
{
    ...
    gatt_client_t *client = gattClient_GetClient(client_id);
    gatt_cid_t client_cid = GattClient_Protected_GetConnectionID(client);
