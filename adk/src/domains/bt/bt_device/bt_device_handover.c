...
REGISTER_HANDOVER_INTERFACE(BT_DEVICE, &bt_device_marshal_types_list, NULL, btDevice_Marshal, btDevice_Unmarshal, btDevice_Commit);


/* statically allocated marshal data because the marshal function needs to pass
   a reference to the data back from btDevice_Marshal. */
