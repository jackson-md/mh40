...
\defgroup   l2cap_manager L2cap Manager
\ingroup    bt_domain
...
/*! \brief Returns whether or not the state of the L2CAP link associated with the specified instance
 *         is connected.

    \param[in] tpaddr       Transport Bluetooth Address of connected device.

    \param[in] instance_id  A unique identifier of an L2CAP service/protocol instance managed by
                            the L2CAP Manager.
