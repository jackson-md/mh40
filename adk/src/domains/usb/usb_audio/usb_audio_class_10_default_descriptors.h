...
#define UAC1D_24BIT_AUDIO_SPKR_SUPPORTED_FREQUENCIES    2
...
extern const uac_streaming_config_t            uac1_hd_music_streaming_spkr_desc[];
extern const usb_audio_interface_config_list_t uac1_hd_music_spkr_voice_mic_interfaces;
