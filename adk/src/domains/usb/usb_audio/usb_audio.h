...
typedef enum
{
    ...
    /*! Client for USB sample rate changes */
    USB_AUDIO_REGISTERED_SAMPLE_RATE,
    /*! Number of clients */
...
typedef enum
{
    ...
    USB_AUDIO_MEDIASERVICE_PLAY_IND,
    USB_AUDIO_MEDIASERVICE_PAUSE_IND    
...
/*! AudioStreaming interface & endpoint descriptor configuration */
typedef struct
{
