...
static const uac_streaming_config_t adaptive_anc_tuning_streaming_mic_desc[] = {
    {
        &adaptive_anc_tuning_mic_endpoint,
...
static const uac_streaming_config_t adaptive_anc_tuning_streaming_spkr_desc[] = {
    {
        &adaptive_anc_tuning_spkr_endpoint,
...
{
    {
        ...
        .streaming_config = adaptive_anc_tuning_streaming_spkr_desc,
        .alt_settings_count = ARRAY_DIM(adaptive_anc_tuning_streaming_spkr_desc)
    },
    {
        .type = USB_AUDIO_DEVICE_TYPE_AUDIO_MIC,
        .control_desc =   &adaptive_anc_tuning_control_mic_desc,
        .streaming_config = adaptive_anc_tuning_streaming_mic_desc,
        .alt_settings_count = ARRAY_DIM(adaptive_anc_tuning_streaming_mic_desc)
    }
};
