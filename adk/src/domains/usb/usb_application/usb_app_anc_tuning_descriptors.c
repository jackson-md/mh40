...
{
    {
        ...
        .streaming_config = anc_tuning_streaming_spkr_desc,
        .alt_settings_count = ARRAY_DIM(anc_tuning_streaming_spkr_desc)
    },
    {
        .type = USB_AUDIO_DEVICE_TYPE_AUDIO_MIC,
        .control_desc =   &anc_tuning_control_mic_desc,
        .streaming_config = anc_tuning_streaming_mic_desc,
        .alt_settings_count = ARRAY_DIM(anc_tuning_streaming_mic_desc)
    }
};
