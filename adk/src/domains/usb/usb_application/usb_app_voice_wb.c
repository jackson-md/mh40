...
{
    {
        ...
        .streaming_config = voice_wb_streaming_mic_desc,
        .alt_settings_count = ARRAY_DIM(voice_wb_streaming_mic_desc)
    },
    {
        .type = USB_AUDIO_DEVICE_TYPE_VOICE_SPEAKER,
        .control_desc =   &uac1_voice_control_spkr_desc,
        .streaming_config = voice_wb_streaming_spkr_desc,
        .alt_settings_count = ARRAY_DIM(voice_wb_streaming_spkr_desc)
    }
};
